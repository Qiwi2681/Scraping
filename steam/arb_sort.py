...
# Read the CSV file
df = pd.read_csv("trolling_graffities.csv")
...
# Sort the items by the highest arbitrage value
sorted_items = latest_prices.sort_values(by='Arbitrage', ascending=False)[['Item Name', 'Arbitrage']]
...
def update_plot(index):
    ...
    ax2.clear()
    ax2.plot(group_data['Timestamp'], group_data['Listings'], label=f'Listings', marker='x')
